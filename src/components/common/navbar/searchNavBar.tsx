...
import {Button, AppBar, Box, Toolbar, IconButton, InputBase, Badge, MenuItem, Menu, ButtonBase} from "@mui/material";
...
export default function Navbar() {
 const navigate = useNavigate();
  ...
  const renderMenu = //modificaremos esta parte de codigo para renderizar los 2 tipos de menus
    (
      <Menu
        anchorEl={anchorEl}
        anchorOrigin={{
